        ...
        <div className="pt-10 bg-[#141414] w-full rounded-md">
            <div className="px-6 mb-6">
                ...
                <div className="flex items-center gap-4 mb-4">
                    <img src={assets.comment_profile} className="w-12 h-12 hover:cursor-pointer" alt="" />
                    <div>
            ...
            <div className="bg-[#1b1b1b] py-6 px-6 sm:flex justify-between items-center rounded-b-md">
                <p className="text-white/50 mb-3 sm:mb-0">Drop a comment, be helpful</p>
                <button className="text-black bg-button hover:bg-[#abfc39] rounded-md px-4 py-1">Submit</button>
            </div>
        </div>
    )
}
